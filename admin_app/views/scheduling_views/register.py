...
class RegisterTeacherScheduleItem(APIView):
    def post(self, request, schedule_item_id):
        ...
        if teacher:
            ...
            # address = format_pencil_box_location(
            ...
            #     'confirmation_message_payload', payload_data=payload_data, message_type='confirmation')
            ...
            #     'reminder_message_payload', payload_data=payload_data, message_type='reminder')
